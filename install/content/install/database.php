...
?>
<form class="form form-horizontal" action="javascript:alert('OK');">
    <fieldset>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input class="form-control" id="inp_db_host" type="text" placeholder="localhost" />
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <input class="form-control" id="inp_db_port" type="text" placeholder="3306" />
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <input class="form-control" id="inp_db_db" type="text" placeholder="imebe_database" required />
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <input class="form-control" id="inp_db_user" type="text" placeholder="imebe_user" required />
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <input class="form-control" id="inp_db_pass" type="password" placeholder="Password" required />
            </div>
        </div>
    </fieldset>
</form>
